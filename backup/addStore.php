...
if (isset($_POST['name']) && isset($_POST['address']) && isset($_POST['phone']) && isset($_POST['category']) && isset($_POST['username']) && isset($_POST['password'])) {
	...
	if (isset($_POST['storeId'])) {
		...
		$updateStoreQuery = "UPDATE stores SET name='$name', address='$address', phone='$phone', category='$category', username='$username', password='$password' WHERE id='$storeId'";
